...
var Fi = (r, e, t) => e in r ? Ei(r, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : r[e] = t;
var u = (r, e, t) => Fi(r, typeof e != "symbol" ? e + "" : e, t);
import * as Et from "ol";
...
import * as zt from "ol/Observable";
function n(r) {
  return r != null;
}
function _(r, e) {
...
const A = {
  paramsNotDefined: Ai,
  paramsListHaveNotDefined: wi,
  paramsInvaildFormat: Pi,
  paramsListInvaildFormat: Ci,
  haveInvaildDataItem: Li
}, Mi = /^rgb\(\s*(25[0-5]|2[0-4]\d|1\d{2}|[1-9]?\d)\s*,\s*(25[0-5]|2[0-4]\d|1\d{2}|[1-9]?\d)\s*,\s*(25[0-5]|2[0-4]\d|1\d{2}|[1-9]?\d)\s*\)$/;
function ve(r) {
...
class Q {
  ...
  withAlpha(e) {
    ...
    if (this._color.startsWith("rgb") && !this._color.startsWith("rgba"))
      ...
      this._initColor([...Di(this._color), e]);
    else {
      if (!n(Pt[this._color])) {
        d(Be("withAlpha", "颜色值有误"));
        return;
      }
      let t = we(Pt[this._color]);
      if (!n(t)) {
        d(Be("withAlpha", "颜色值有误"));
        return;
      }
...
class ne {
  constructor(e) {
    ...
    let h;
    a ? h = Ui(a) : l ? h = Ni(l) : f && (h = Ki(f)), this._style = new K.Style({
      fill: Vi(t),
      stroke: Zi(i),
      image: h
    });
...
function Xi(r) {
  return Object.values(ui).includes(r);
}
const qi = {
  offset: new R(0, 0),
...
function Oe(r, e, t) {
  ...
  switch (e) {
    ...
    case "change:element":
      ...
      break;
    case "change:offset":
      l.oldValue = new R(i[0], i[1]), l.newValue = r.getOffset();
      break;
...
class ci {
  constructor(e) {
    ...
    var i;
    n(e.id) && (this.id = e.id);
    let t = Object.assign({}, qi, e);
    delete t.id, n(t.content) && L(t.content) && !n(t.element) && (this.content = t.content, t.element = Mt(t.content)), n(t.element) && t.element.classList.add("omap-popup-selectable"), this._popup = new zi({
      ...t,
  ...
  setContent(e) {
    this._isInitialized("setContent") && (this.events.emit("change:content", Oe(this, "change:content", {
      ...
      key: "content",
      newValue: e
    })), this.content = e, this.setElement(Mt(e)));
  }
  getOffset() {
  ...
  setOffset(e) {
    ...
    let t = e instanceof R ? e.toArray() : e;
...
const bt = 1, Gt = !0, Dt = 0, Tt = 22, Rt = 0, kt = 1 / 0, $t = 1, Bt = {};
class T {
  constructor(e, t) {
    /**
     * 图层类型
    ...
    u(this, "maxZoom", Tt);
    // 最大缩放级别，默认22
    u(this, "minResolution", Rt);
    // 最小分辨率，默认0r
    u(this, "maxResolution", kt);
    // 最大分辨率，默认Infinity
    u(this, "zIndex", $t);
    // 图层层级，默认0
    u(this, "properties", Bt);
    // 图层属性，用于存储图层相关信息
    /**
     * 图层所属的地图对象
     */
    ...
    u(this, "target", null);
    let i = _(t, {});
    this.type = e, lt = `${e}Layer`, P = y(lt), this.id = _(i.id, null), this.name = _(i.name, ""), this.className = _(i.className, ""), this.opacity = _(i.opacity, bt), this.visible = _(i.visible, Gt), this.extent = _(i.extent, null), this.minZoom = _(i.minZoom, Dt), this.maxZoom = _(i.maxZoom, Tt), this.minResolution = _(i.minResolution, Rt), this.maxResolution = _(i.maxResolution, kt), this.zIndex = _(i.zIndex, $t), this.properties = _(i.properties, Bt), this.map = _(i.map, null), ge.set(this, {
      groupId: null
    });
  }
  _isInitialized(e) {
...
class B {
   ...
   */
  destroy(e = !0) {
    this._isInitialized("destroy") && (e && n(this.getLayer()) && this.removeInteractionLayer(), n(this.map) && this.map.removeInteraction(this));
  }
  /**
   * 移除交互图层
   */
...
class lr extends H {
  ...
  appendPoint(e) {
    ...
    let t = null;
    if (e instanceof Te ? t = e.getGeometry() : e instanceof c ? t = new w.Point(e.toArray()) : G(e) && (t = new w.Point(e)), !n(t)) {
  ...
  getClosestPoint(e) {
    ...
    let t = null;
    if (e instanceof Te ? t = e.getCoordinates().toArray() : e instanceof c ? t = e.toArray() : G(e) && (t = e), !n(t)) return;
...
let Z = null, U = null, Fe = null, vt = null, Ie = null, me = [], q = [];
function yr(r, e, t) {
  r === J.Distance ? Fe = e : r === J.Area && (vt = e), Ie = t;
}
function fi(r) {
  let e = document.createElement("div");
...
function Er(r) {
  if (q.length === 2)
    return Wt(), me = [], q.forEach((e, t) => {
      Kt(t), t === q.length - 1 && (q = []);
    }), !1;
  Wt(r), me.splice(r, 1), me.forEach((e, t) => {
    e.className = `${It}-${t}`, e.setAttribute(ht, t.toString());
  }), Kt(r), q.splice(r, 1), q.forEach((e, t) => {
    e.id = _t(t);
  }), Fr();
}
function Kt(r) {
...
const ie = new hi("单击地图开始测量"), ye = new hi(""), xr = "Measure", Yt = y(xr);
let Xt = null, he = null;
class gi extends B {
  constructor(t, i) {
    if (!Object.values(J).includes(t)) {
      d(Yt("constructor", "mode参数有误"));
      return;
    }
    super("Measure");
    u(this, "mode", null);
  ...
  onMeasureStart(t) {
    var i;
    if (n(t)) {
      Xt = t, yr(this.mode, t, this.map);
      let s = 0;
      (i = Xt.getGeometry()) == null || i.on("change", (a) => {
        var f, h;
        const { target: l } = a;
        if (n(l)) {
          ...
          if (l instanceof w.LineString ? x = (f = this.map) == null ? void 0 : f.getLength(new yt(new M({
            geometry: l
          }))) : l instanceof w.Polygon && (x = (h = this.map) == null ? void 0 : h.getArea(new di(new M({
            geometry: l
          })))), n(x) && m(x) && (this.result.value = x), n(x) && m(x) && l instanceof w.LineString) {
            let k = v >= 2 ? Ir(gt(x), x === 0 ? "" : "单击继续，双击结束测量") : fi("单击地图开始测量");
            ie.setElement(k);
          }
          if (l instanceof w.LineString) {
            if (v > s) {
              let k = v - 1 - 1, X = Nt(gt(x), k), ee = Ut({
                id: _t(k),
                element: X,
                offset: new R(0, -10)
              });
          ...
          } else l instanceof w.Polygon && v >= 4 && (this.map.addPopup(ye.getPopup()), ye.setElement(Zt(Ht(x), "单击继续，双击结束测量")), ye.updatePosition(l.getInteriorPoint().getCoordinates()), ie.setElement(void 0), ie.updatePosition(void 0));
        } else
   ...
   */
  onMeasureEnd() {
    if (this.setActive(!1), n(he) && zt.unByKey(he), this.mode, J.Distance, this.mode === J.Area) {
      const t = Zt(Ht(this.result.value));
...
class ze extends T {
  ...
  initVectorLyaerEvent() {
    this._isInitializedLayer("initVectorLyaerEvent") && this._layer.getSource().on("addfeature", (t) => {
      const { feature: i } = t;
      if (n(i) && (this.target instanceof _i || this.target instanceof gi)) {
        let s = ae(i);
  ...
  getClosestFeatureToCoordinate(t, i) {
    ...
    let s = I(t), a = i ? (h) => {
      let v = g.getUid(h), x = this.features.findIndex((k) => g.getUid(k.getFeature()) === v);
...
class _i extends B {
  ...
  initDrawEvent() {
    this._isInitialized("initDrawEvent") && this._interaction.on("drawend", (e) => {
      const t = e.feature;
      if (console.log(t), n(t)) {
        let i = ae(t);
        i ? this.layer.addFeature(i) : o(Ze("createBaseFeatureByOlFeature", "根据olFeature创建BasicFeature出错"));
      }
    });
  }
  /**
  ...
  appendCoordinates(e) {
    ...
    if (!n(e)) {
      o(Ze("appendCoordinates", "coordinates参数不能为空"));
      return;
    }
    let t = e.map((i) => i instanceof c ? i.toArray() : i);
...
class qt {
  constructor(e, t) {
    ...
    const s = i.filter((a) => n(a) && n(a.getLayer()) && a instanceof T);
...
class Mr extends B {
  constructor(e) {
    super("MouseWheelZoom"), this._interaction = new j.MouseWheelZoom(Object.assign(mi, Lr, _(e, {}))), this.initInteractionEvent(), n(e) && n(e.id) && this._initInteractionId(e.id);
  }
}
const Sr = {
  duration: 250,
...
class br extends B {
  constructor(e) {
    super("DoubleClickZoom"), this._interaction = new j.DoubleClickZoom(Object.assign(mi, Sr, _(e, {}))), this.initInteractionEvent(), n(e) && n(e.id) && this._initInteractionId(e.id);
  }
}
const Gr = {
  onFocusOnly: !1,
...
class Dr extends B {
  constructor(e) {
    super("DragPan"), this._interaction = new j.DragPan(Object.assign({}, Gr, e || {})), this.initInteractionEvent(), n(e) && n(e.id) && this._initInteractionId(e.id);
  }
}
const Tr = [
  new Mr({ id: "omap_default_mousewheelzoom" }),
  new br({ id: "omap_default_doubleclickzoom" }),
  new Dr({ id: "omap_default_dragpan" })
], Rr = [], Ue = {
  pixelRatio: Ri(),
  layers: [],
  controls: [],
...
function Ne(r, e, t) {
  ...
  switch (e) {
    ...
    case "map:dbclick":
      t.pixel && (i.pixel = new R(...t.pixel)), t.coordinate && (i.coordinate = new c(...t.coordinate));
      break;
...
let ps = class {
  constructor(e, t) {
    ...
    let h = _(i.interactions, Ue.interactions), v = _(i.controls, Ue.controls), x = _(i.popups, Ue.popups), k = Object.assign({}, Ue, {
      ...i,
      interactions: [],
      overlays: [],
      view: f
  ...
  addLayer(e) {
    ...
    n(e.getLayer()) && (this.layers.push(e), n(e.getTarget()) || e.setTarget(this), this._map.addLayer(e.getLayer()));
  }
  /**
   * 添加多个图层
  ...
  getLayerById(e) {
    ...
    return this.layers.forEach((i) => {
      i instanceof T && n(i.getId()) && i.getId() === e && (t = i);
    }), t;
  }
  /**
   * 移除图层
  ...
  on(e, t) {
    ...
    return (!n(a) || n(a) && a.length === 0) && (i ? s.on(e.replace("map:", ""), (f) => {
      this.events.emit(e, Ne(this, e, f));
  ...
  addInteraction(e) {
    ...
    if (e instanceof _i || e instanceof gi) {
      const i = e.getLayer();
  ...
  removeInteraction(e) {
    ...
    let t = this.interactions.findIndex((i) => g.getUid(i.getInteraction()) === g.getUid(e.getInteraction()));
    if (t === -1) {
      o(p("removeInteraction", "该交互未添加到地图中"));
      return;
    }
    n(e.getInteraction()) && (this.interactions.splice(t, 1), this._map.removeInteraction(e.getInteraction()), e.setMap(null));
  }
  /**
   * 控件管理
   */
  ...
  /** 几何图形计算 */
  getLength(e) {
    return this._isInitialized("getLength") ? Ft.getLength(e.getGeometry(), {
      projection: this._map.getView().getProjection()
    }) : void 0;
  }
  getArea(e) {
    return this._isInitialized("getArea") ? Ft.getArea(e.getGeometry(), {
      projection: this._map.getView().getProjection()
    }) : void 0;
  }
  /**
...
class vs extends T {
  constructor(t, i) {
    ...
    this._layer = new oe.Tile({
      ...
      background: n(s.background) ? $e(s.background) : void 0,
      source: l
    }), this._initLayerEvent();
  }
}
const Ur = "ProjUtil", ti = y(Ur);
class Es {
  static fromLonLat(e, t) {
    if (!n(e)) {
      o(ti("fromLonLat", "coordinate参数不能为空"));
      return;
    }
    let i = e;
  ...
  static toLonLat(e, t) {
    if (!n(e)) {
      o(ti("toLonLat", "coordinate参数不能为空"));
      return;
    }
    let i = e;
    e instanceof c && (i = e._lnglat);
...
const pi = new Proxy(Nr, {
  set: function(r, e, t, i) {
    return Kr(e, t), Reflect.set(r, e, t, i);
  }
}), W = {
  GeoJSON: "GeoJSON",
  WKT: "WKT",
...
function Jr(r, e) {
  const i = D().readFeature(r, _(e, {}));
  return ae(i);
}
function Qr(r, e) {
  return D().readFeatures(r, _(e, {})).map((a) => ae(a));
}
function en(r, e) {
  return D().writeFeature(r.getFeature(), Object.assign({}, le, _(e, {})));
}
function tn(r, e) {
  return D().writeFeatureObject(r.getFeature(), Object.assign({}, le, _(e, {})));
}
function rn(r, e) {
  return D().writeFeatures(r.map((s) => s.getFeature()), Object.assign({}, le, _(e, {})));
}
function nn(r, e) {
  return D().writeFeaturesObject(r.map((s) => s.getFeature()), Object.assign({}, le, _(e, {})));
}
const sn = {
  readFeature: Jr,
  readFeatures: Qr,
  writeFeature: en,
  writeFeatureObject: tn,
  writeFeatures: rn,
  writeFeaturesObject: nn
};
function on(r, e) {
  const i = D().readFeature(r, _(e, {}));
  return ae(i);
...
function Cn(r, e) {
  return Pn.replace(/\{T\}/g, r + "_" + e).replace(/\{tk\}/g, pi.tdt);
}
let Ln = "TdtLayer", ii = y(Ln);
class zs extends T {
  constructor(t, i) {
    var a, l, f;
    super("Tdt", i);
    ...
    u(this, "tdtType", null);
    if (!n(pi.tdt)) {
      o(ii("constructor", "缺少天地图key，请提前申明"));
      return;
    }
    if (!n(t)) {
      d(ii("constructor", "缺少参数天地图图层类型"));
      return;
    }
    let s = i || {};
    this.tdtType = t, this._layer = new oe.Tile({
      ...
      source: new se.XYZ({
        url: Cn(t, (i == null ? void 0 : i.proj) || "w")
      })
    }), this._initLayerEvent();
  }
}
...
class As extends T {
  constructor(e) {
    ...
    _(e.source, {}), this._layer = new oe.Tile({
      ...
      background: n(t.background) ? $e(t.background) : void 0
    }), this._initLayerEvent();
  }
}
const Gn = {
...
let Wn = "ImageLayer", Hn = y(Wn);
class Ls extends T {
  constructor(e) {
    if (super("Image", _(e, {})), !n(e.source)) {
      o(Hn("constructor", "缺少source参数"));
      return;
    }
...
function ri(r, e, t) {
  return {
    target: r,
    type: e,
    pixel: new R(t.pixel[0], t.pixel[1]),
    coordinate: new c(t.coordinate[0], t.coordinate[1])
  };
}
const Yn = "DragBox", Ke = y(Yn);
class Ms extends B {
  constructor(e) {
  ...
  on(e, t) {
    ...
    return (!n(i) || i.length === 0) && this._interaction.on(e, (a) => {
      this.events.emit(e, ri(this, e, a));
    }), this.events.on(e, t);
  }
  un(e) {
    if (this._isInitialized("un")) {
...
class Ss extends B {
  constructor(e) {
    super("Extent"), this._interaction = new j.Extent(Object.assign({}, Xn, e || {})), this.initInteractionEvent();
  }
  getExtent() {
    if (!this._isInitialized("getExtent")) return;
...
class bs extends B {
  ...
  on(t, i) {
    ...
    return (!n(s) || s.length === 0) && this._interaction.on(t, (l) => {
      this.events.emit(t, ni(this, t, l));
    }), this.events.on(t, i);
  }
  un(t) {
    if (this._isInitialized("un")) {
...
function We(r) {
  ...
  if (Je.length)
    ...
    e = Ii.find((t) => g.getUid(t._feature) === r);
  return e;
}
function si(r, e, t) {
  return {
...
class Gs extends B {
  constructor(t) {
    ...
    u(this, "deselected", []);
    let i = [];
    n(t == null ? void 0 : t.layers) && (Qn(t.layers), i = t.layers.map((s) => s._layer)), n(t == null ? void 0 : t.features) && es(t.features), this._interaction = new j.Select(Object.assign({}, is, {
      ...t,
      layers: i,
  ...
  on(t, i) {
    ...
    let s = this.events.get(t);
    return (!n(s) || s.length === 0) && this._interaction.on(t, (l) => {
      console.log("select", l), this.events.emit(t, Object.assign({}, si(this, t, l), {
  ...
  once(t, i) {
    ...
    let s = this.events.get(t);
    return (!n(s) || s.length === 0) && this._interaction.on(t, (l) => {
      this.events.emit(t, Object.assign({}, si(this, t, l), {
        selected: this.selected,
        deselected: this.deselected
      }));
    }), this.events.once(t, i);
...
class Ds extends B {
  constructor(e) {
    ...
    this._interaction = new j.Link(Object.assign({}, rs, t)), this.initInteractionEvent();
  }
}
const ns = {
  duration: 100,
...
class Ts extends B {
  constructor(e) {
    super("KeyboardZoom"), this._interaction = new j.KeyboardZoom(Object.assign({}, ns, e || {})), this.initInteractionEvent();
  }
}
class Rs extends B {
  constructor(e) {
...
const as = "FullScreen", ls = y(as);
class $s extends vi {
  constructor(e, t) {
    super("FullScreen"), n(e) && (m(e) || L(e)) ? (this.id = e, this._control = new Xe.FullScreen(Object.assign({}, oi, t))) : this._control = new Xe.FullScreen(Object.assign({}, oi, e));
  }
  _isInitialized(e) {
    return n(this._control) ? !0 : (o(ls(e, "未正确实例化")), !1);
  }
}
const ai = {
  duration: 250,
...
class Bs extends vi {
  constructor(e, t) {
    super("Zoom"), n(e) && (m(e) || L(e)) ? (this.id = e, this._control = new Xe.Zoom(Object.assign({}, ai, t))) : this._control = new Xe.Zoom(Object.assign({}, ai, e));
  }
  _isInitialized(e) {
    return n(this._control) ? !0 : (o(cs(e, "未正确实例化")), !1);
  }
}
export {
  gr as Circle,
  ...
  Bs as FullScreen,
  vs as GaodeLayer,
  Is as GaodeLayerType,
  Ls as ImageLayer,
  Ss as InteractionExtent,
