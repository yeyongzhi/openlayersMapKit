...
export type OMapFormatOptionsType =
  OMapFormatGeoJSONOptions | OMapFormatWKTOptions | OMapFormatKMLOptions
...
export type OMapFormatInstanceType =
  | OMapGeoJSONFormatInstanceType
  | OMapWKTFormatInstanceType
  | OMapKMLFormatInstanceType
  | OMapEsriJSONFormatInstanceType
