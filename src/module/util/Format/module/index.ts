...
function handle<Result = unknown>(format: OMapFormatInstanceType, type: OMapFormatTypeEnum, key: string, ...args: unknown[]): Result | undefined {
    ...
    if (typeof method === 'function') {
        return (method as (format: OMapFormatInstanceType, ...args: unknown[]) => Result)(format, ...args)
    } else {
...
export function handleWriteFeature(format: OMapFormatInstanceType, type: OMapFormatTypeEnum, feature: BasicFeature<OlGeometryType>, options?: OMapFormatWriteFeatureOptionsType) {
    return handle<string>(format, type, 'writeFeature', feature, options) as string
}

export function handleWriteFeatureObject(format: OMapFormatInstanceType, type: OMapFormatTypeEnum, feature: BasicFeature<OlGeometryType>, options?: OMapFormatWriteFeatureOptionsType) {
    return handle(format, type, 'writeFeatureObject', feature, options)
}

export function handleWriteFeatures(format: OMapFormatInstanceType, type: OMapFormatTypeEnum, features: Array<BasicFeature<OlGeometryType>>, options?: OMapFormatWriteFeatureOptionsType) {
    return handle<string>(format, type, 'writeFeatures', features, options) as string
}

export function handleWriteFeaturesObject(format: OMapFormatInstanceType, type: OMapFormatTypeEnum, features: Array<BasicFeature<OlGeometryType>>, options?: OMapFormatWriteFeatureOptionsType) {
    return handle(format, type, 'writeFeaturesObject', features, options)
}

export function handleWriteFeaturesNode(format: OMapFormatInstanceType, type: OMapFormatTypeEnum, features: Array<BasicFeature<OlGeometryType>>, options?: OMapFormatWriteFeatureOptionsType) {
