...
export function isOMapPopupEventType(value: unknown): value is OMapPopupEventType {
  return isString(value) && OMapPupupEventTypes.includes(value as OMapPopupEventType)
}
