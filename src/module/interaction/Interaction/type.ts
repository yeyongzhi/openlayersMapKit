...
import type { OlInteractionMouseWheelZoomInstanceType, OMapMouseWheelZoomType } from '../MouseWheelZoom/type'
import type { OlInteractionDoubleClickZoomInstanceType, OMapDoubleClickZoomType } from '../DoubleClickZoom/type'
import type { OlInteractionKeyboardZoomInstanceType, OMapKeyboardZoomType } from '../KeyboardZoom/type'
...
export type OMapInteractionTypeEnum = 'Draw' | 'DragBox' | 'DragPan' | 'InteractionExtent' |  'Extent' | "Modify" | "Measure" | "Select" | "Link" | "MouseWheelZoom" | "DoubleClickZoom" | "KeyboardZoom" | "DragZoom"
export type OMapInteractionType = OMapDrawType | OMapDragBoxType | OMapDragPanType | OMapInteractionExtentType | OMapInteractionExtentType | OMapModifyType | OMapSelectType | OMapLinkType | OMapMouseWheelZoomType | OMapDoubleClickZoomType | OMapKeyboardZoomType | OMapDragZoomType
...
export function isVaildInteraction<T extends OMapInteractionCommonType>(value: unknown): value is Interaction<T> {
