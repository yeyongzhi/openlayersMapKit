...
export const OMapInteractionKeyboardZoomEventTypes = [
...
export function isOMapInteractionKeyboardZoomEventType(
  ...
  return (
    isString(value) && OMapInteractionKeyboardZoomEventTypes.includes(value as OMapInteractionKeyboardZoomEventType)
  );
}