...
export const OMapInteractionDragZoomEventTypes = [
  ...OMapInteractionCommonEventTypes,
];
export type OMapInteractionDragZoomEventType =
  (typeof OMapInteractionDragZoomEventTypes)[number];
...
export function isOMapInteractionDragZoomEventType(
  ...
  return (
    isString(value) && OMapInteractionDragZoomEventTypes.includes(value as OMapInteractionDragZoomEventType)
  );
}