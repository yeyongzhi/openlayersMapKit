...
export type OMapMeasureParamsType = OMapInteractionCommonParamsType &
...
export interface OMapMeasureEvent {
  target: Measure
  type: OMapInteractionMeasureEventType
  result?: Readonly<OMapMeasureResult>
}

export type OMapMeasureEventMap = Record<OMapInteractionMeasureEventType, [event: OMapMeasureEvent]>
