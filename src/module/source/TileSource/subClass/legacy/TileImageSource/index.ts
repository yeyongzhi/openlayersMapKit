...
export default class TileImageSource extends TileSource<OMapTileImageSourceType> {
    ...
    constructor(params: OMapTileImageSourceParamsType) {
        super(new OlSource.TileImage(handleGetTileImageSourceParams({
            ...DEFAULT_TILE_IMAGE_SOURCE_PARAMS,
            ...params
    ...
    setTileLoadFunction(tileLoadFunction: ReturnType<OMapTileImageSourceType['getTileLoadFunction']>) {
    ...
    setTileUrlFunction(tileUrlFunction: ReturnType<OMapTileImageSourceType['getTileUrlFunction']>, key?: string) {
