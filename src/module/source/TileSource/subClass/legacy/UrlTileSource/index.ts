 ...
 */
export default class UrlTileSource<
  T extends OMapUrlTileSourceType = OMapUrlTileSourceType
> extends TileSource<T> {
  constructor(params: OMapUrlTileSourceParamsType) {
    super(
      new OlSource.UrlTile(
        handleGetUrlTileSourceParams({
          ...DEFAULT_URL_TILE_SOURCE_PARAMS,
          ...params
        } as OMapUrlTileSourceParamsType)
      ) as T
    )
  }
