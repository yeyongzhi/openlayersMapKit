...
export default class OGCVectorTileSource<
  FeatureType extends FeatureLike = FeatureLike
> extends TileSource<OMapOGCVectorTileSourceType<FeatureType>> {
  constructor(params: OMapOGCVectorTileSourceParamsType<FeatureType>) {
    super(
      new OlSource.OGCVectorTile(
        handleGetOGCVectorTileSourceParams({
          ...DEFAULT_OGC_VECTOR_TILE_SOURCE_PARAMS,
          ...params
        } as OMapOGCVectorTileSourceParamsType<FeatureType>)
      ) as OMapOGCVectorTileSourceType<FeatureType>
    )
  }
