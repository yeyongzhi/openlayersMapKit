...
| `on(type: "change:position" \| "change:positioning" \| "change:element" \| "change:offset" \| "change:content" \| "change:properties", callback: (event: OMapPopupEventTarget) => void): string \| undefined`   | —                                                       |
| `once(type: "change:position" \| "change:positioning" \| "change:element" \| "change:offset" \| "change:content" \| "change:properties", callback: (event: OMapPopupEventTarget) => void): string \| undefined` | —                                                       |
