...
| 成员                                                                                         | 说明 |
| -------------------------------------------------------------------------------------------- | ---- |
| `fromLonLat(coordinate: number[] \| Lnglat, projection?: OMapProjType): Lnglat \| undefined` | —    |
| `toLonLat(coordinate: number[] \| Lnglat, projection?: OMapProjType): Lnglat \| undefined`   | —    |
